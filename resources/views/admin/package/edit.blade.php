...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form  autocomplete="off" action="{{ route('package.update', $package['id'] )}}" method="post" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="card">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ $package['packageTitle'] }}"  name="packageTitle" type="text" required />
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ $package['packageTotalPrice'] }}" name="packageTotlePrice"  required type="number" />
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ $package['packageFee'] }}"  name="packageFee" required type="number" />
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ $package['stateFee'] }}"  name="stateFee" required type="number" />
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('property_type') ? ' has-danger' : '' }}">
                        <select class="form-control" id="company_type" name="company_type">
                          ...
                          <option value="1" {{ 1 == $package['companyType']['id'] ? 'selected' : '' }}> Sociedad Anónima</option>
                          <option value="2" {{ 2 == $package['companyType']['id'] ? 'selected' : '' }} >Sociedad De Responsabilidad Limitada</option>
                        </select>
                ...
                @foreach(json_decode($package['packageDetail']) as $key=>$feature)
                  <div class="row feature-group">
                    <label class="col-sm-2 col-form-label">{{ $key }}</label>
                        <div class="col-sm-7">
                          <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}"  value="{{$feature}}" name="features[]" id="feature1"  />
                          </div>
                        </div>

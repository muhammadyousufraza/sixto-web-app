                ...
                @csrf
                    ...
                    <div class="form-group py-1 pb-3">
                        <div class="input-field"> <span class="fas fa-lock p-2"></span> <input type="text"
                                placeholder="Old Password" name="userPassword" required class=""> 
                                <!-- <button class="btn bg-white text-muted">
                                <span class="far fa-eye-slash"></span> </button> -->
                        </div>
                        <div class="input-field"> <span class="fas fa-lock p-2"></span> <input type="text"
                                placeholder="New Password" name="userPassword" required class=""> 
                                <!-- <button class="btn bg-white text-muted">
                                <span class="far fa-eye-slash"></span> </button> -->
                        </div>
                    </div>
                    
                    </div> <button class="btn btn-block text-center my-3">Change Password</button>

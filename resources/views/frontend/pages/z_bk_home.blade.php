...
<header id="myHeader">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="inner-wrap">
                        ...
                        <p class="col-md-8 home-text-sub-text">Discover seamless business setup solutions tailored to your needs. Our expert team can guide you through the best options for establishing a company in Costa Rica,ensuring a streamlined process completed in less than 48 hours.</p>
                        <form action="" class="col-md-10">
                            <input type="text" class="w-75" placeholder="Enter your preferred buisness name">
                            <a href="javascript:;" class="brown-btn btn">start now</a>
                        </form>
            ...
            <div class="row align-items-center">
                <div class="col-md-3 col-sm-12">
                    <div class="content">
                        ...
                        <p>Identify the LLC package and services the fit your needs and then get started.</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-12">
                    <div class="box">
    ...
    <!-- section 4 end -->
    <!-- section 5 start -->
    <section class="sec5 bg-blue px-5">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 m-auto">
                    <div class="content">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the in- dustry`s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum is simply dummy text of the printing and type- setting industry.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 p-5 m-auto">
                    <div class="content">
                        <h6 class="py-5">Launching Your Business in Costa Rica: A 3-Steps Guide</h6>
                        <ul>
                ...
                <div class="col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/index/company" class="brown-btn btn px-4">From a Company</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">From a Company</h5>
                                <p class="card-text">Start your company, and open bank accounts to start your Journey in Costa Rica</p>
                                <a href="/index.php/company" class="brown-btn btn px-4">From a Company</a>
                            </div>
                        </div>
                    </div>

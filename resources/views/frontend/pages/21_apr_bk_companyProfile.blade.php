                        ...
                        <div class="container">
                            <div class="row text-center">
                                ...
                                <?php if($package['companyType']['id'] == 1) : ?>
                                    <div class="col-lg-4 col-md-6 m-auto" onclick='selectPackage("pkg_{{$package['id']}} _type_{{$package['companyType']['id']}}")'  id="pkg_{{$package['id']}} _type_{{$package['companyType']['id']}}">
                                    <div class="plan-card">

...
<header id="myHeader">
    ...
    <section class="sec1 inner-page-header  bg-image py-4 pg-banner" style="background: url('{{ asset('assets/Images/migration.png') }}');">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xxl-10">
                    <div class="text-center">
                        <h2 class="fw-bolder mb-3">Legal Advice on Migracion in Costa Rica</h2>
                        <p class="lead fw-normal text-muted mb-4">
                            Discover how we simplify the migration procedures in Costa Rica for foreign clients. From obtaining residency to advice on investments and starting businesses, our specialized legal team is here to guide you.
                        </p>
                        <p class="lead fw-normal text-muted mb-4">
                            Explore Our Migration Services for detailed information on how we can help you achieve your goals. We specialize in residency procedures, investor residency, and resident manager residency.
                        </p>
                            ...
                            <form id="Contact_form" class="contact-form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Service</label>
                                            <input type="text" class="form-control" id="service" value="Migracion" name="service" placeholder="Migracion" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-12">

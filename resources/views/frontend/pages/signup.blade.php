        ...
        <div class="container">
            <div class="form-wrapper  bg-white">
                ...
                <form class="pt-3">
                    ...
                    <div class="form-group py-1 pb-3">
                        <div class="input-field"> <span class="fas fa-lock p-2"></span> <input type="text"
                                placeholder="Email" required class=""> 
                                <!-- <button class="btn bg-white text-muted">
                                <span class="far fa-eye-slash"></span> </button> -->
                        </div>
                    </div>
                    ...
                    <div class="text-center pt-3 text-muted">Don't have an account? <a href="/index.php/customer/login" class="text-decoration-underline">Login</a></div>
                </form>
            </div>
        </div>
    </section>

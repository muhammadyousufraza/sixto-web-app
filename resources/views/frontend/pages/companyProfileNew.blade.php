...
<body>
 ...
 <div class="main-form-wrapper" style="background-color: #f0f4f5; padding: 70px 0;">
     <div class="container">
        <form id="stepForm" style="background: none; border-radius:0; padding: 0;" action="{{ route('company.create') }}" method="POST">
            @csrf
            <div class="step">
            ...
            <div class="step" id="select_manager">
                <section class="from-wrapper py-4">
                    <div class="container">
                        <div class="row justify-content-center text-center">
                            <div class="col-md-7">
...
<script>
    ...
    const updateSubmitButtonState = () => {
        ...
        if (combinedPercentage === 100) {
            ...
            if (combinedPercentage > 100) {
                errorMessageSpan.textContent = 'The combined percentage of shares must be 100.';
            }
        }
    };
    ...
    formContainer.addEventListener('input', updateSubmitButtonState);
...
function onChangeRepresentative() {
    ...
    if (noOptionRespresentive.length <= 0 && noOptionManager.length <= 0) {
